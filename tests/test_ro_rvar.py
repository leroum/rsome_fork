...
def test_rvar_scalar():
    ...
    assert z.ndim == 0
    assert z.vtype == "C"
    assert z.__repr__() == "0: a random variable"
...
def test_rvar_array():
    ...
    assert z.ndim == 1
    assert z.vtype == "C"
    assert z.__repr__() == "0: 4 random variables"
    ...
    assert z[2].__repr__() == "slice of 0: a random variable"
    assert z[2:4].to_affine().shape == (2,)
    assert z[2:4].__repr__() == "slice of 0: 2 random variables"
    ...
    assert z.vtype == "C"
    assert z.__repr__() == "1: 2x3x4 random variables"
    ...
    assert z[:, 1].__repr__() == "slice of 1: 2x4 random variables"
    assert z[:, 1:3].to_affine().shape == (2, 2, 4)
    assert z[:, 1:3].__repr__() == "slice of 1: 2x2x4 random variables"
    assert z[0, 1:3, :].to_affine().shape == (2, 4)
    assert z[0, 1:3].__repr__() == "slice of 1: 2x4 random variables"
    assert z[0, 2, 1].to_affine().shape == ()
    assert z[0, 2, 1].__repr__() == "slice of 1: a random variable"
